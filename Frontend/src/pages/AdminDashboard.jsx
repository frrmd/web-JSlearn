...
export default function AdminDashboard() {
  ...
  if (loading) {
    return (
      <>
        <AdminTopbar />
        <div className="pt-20 p-8 bg-[#fbffe2] min-h-screen text-[#313c0f] text-center">Loading dashboard...</div>
      </>
    );
  }
  ...
  return (
    <>
      <AdminTopbar />
      <div className="pt-20 p-8 bg-[#fbffe2] min-h-screen text-[#313c0f] pb-24">
