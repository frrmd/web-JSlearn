    ...
    <div className="bg-background font-body text-on-background min-h-screen pb-32">
      ...
      <header className="fixed top-0 w-full z-50 bg-[#fbffe2]/80 dark:bg-slate-900/80 backdrop-blur-xl tonal-transition">
        <div className="flex justify-between items-center px-6 py-4 max-w-7xl mx-auto">
          ...
          <div className="flex items-center gap-4 bg-surface-container-lowest/50 px-4 py-2 rounded-full shadow-sm">
            <span className="text-sm font-bold font-headline flex items-center gap-1">5 🔥</span>
            <span className="text-sm font-bold font-headline flex items-center gap-1 text-secondary">120 XP</span>
            <span className="text-sm font-bold font-headline flex items-center gap-1 text-error">3 ❤️</span>
          </div>
        </div>
      </header>
      ...
      <main className="pt-24 px-6 space-y-8">
        ...
        <section className="space-y-4">
          <div className="flex justify-between items-end">
            <div>
              <p className="text-on-surface-variant font-bold text-xs uppercase tracking-widest font-headline">Currently Learning</p>
              <h2 className="text-2xl font-black font-headline text-primary">Level 2: JS Basics</h2>
            </div>
            <p className="text-primary font-bold font-headline">65%</p>
          </div>
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="bg-surface-container-low p-6 rounded-lg flex flex-col justify-between space-y-6">
            <div className="flex justify-between items-start">
              <h4 className="font-headline font-extrabold text-lg">Daily Goal</h4>
            ...
            <p className="text-sm font-medium text-on-surface-variant">Almost there! 10 more XP to maintain your streak.</p>
          </div>

          <div className="grid grid-cols-2 gap-4">
            <div className="bg-tertiary/10 p-4 rounded-lg flex flex-col items-center justify-center text-center gap-2 border-b-4 border-tertiary/20">
              <span className="material-symbols-outlined text-tertiary text-3xl">workspace_premium</span>
              <p className="text-xs font-bold font-headline uppercase text-tertiary">Rank</p>
              <p className="text-xl font-black font-headline">#12</p>
            </div>
            <div className="bg-secondary/10 p-4 rounded-lg flex flex-col items-center justify-center text-center gap-2 border-b-4 border-secondary/20">
              <span className="material-symbols-outlined text-secondary text-3xl">schedule</span>
              <p className="text-xs font-bold font-headline uppercase text-secondary">Time</p>
              <p className="text-xl font-black font-headline">45m</p>
            </div>
          </div>
        </section>
